...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link href="/UI/HTML/css/animate.css" rel="stylesheet">
        <link href="/UI/HTML/vendor/swiper/css/swiper.min.css" rel="stylesheet" type="text/css"/>

        <!-- THEME STYLES -->
        <link href="/UI/HTML/css/layout.min.css" rel="stylesheet" type="text/css"/>
